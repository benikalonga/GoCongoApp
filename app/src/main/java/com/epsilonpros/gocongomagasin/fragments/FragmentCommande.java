...
public class FragmentCommande extends Fragment implements FullScreenDialogContent, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.frag_commande, container, false);
    }
